...
CREATE TABLE IF NOT EXISTS public.share_activities (
  ...
  CONSTRAINT unique_daily_platform_share UNIQUE (user_id, content_type, content_id, platform, share_date)
);
...
ON public.share_activities (user_id, content_type, content_id, platform, share_date);

-- Add Creator Pro subscription columns to profiles table
...
-- Create brand_deals table for sponsor payment system
...
-- Create subscription tiers table for Creator Pro pricing
...
-- RLS policy for subscription_tiers (publicly viewable)
CREATE POLICY "Subscription tiers are publicly viewable" 
ON public.subscription_tiers 
FOR SELECT 
USING (is_active = true);

-- Insert Creator Pro tier
INSERT INTO public.subscription_tiers (name, stripe_price_id, price_cents, features) 
VALUES (
    'Creator Pro', 
    'price_creator_pro', 
    2999, 
    '["AI Content Generator", "Advanced Analytics", "Priority Support", "Campaign Boost Tools", "Custom Branding"]'::jsonb
);

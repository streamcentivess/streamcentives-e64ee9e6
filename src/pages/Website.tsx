        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Tabs defaultValue="general" className="w-full">
            <TabsList className="grid w-full max-w-md mx-auto grid-cols-2 mb-12">
              <TabsTrigger value="general" className="text-stone-50 bg-blue-400 hover:bg-blue-300">For Fans</TabsTrigger>
              <TabsTrigger value="creators" className="text-stone-50 bg-blue-400 hover:bg-blue-300">For Creators</TabsTrigger>
            </TabsList>
